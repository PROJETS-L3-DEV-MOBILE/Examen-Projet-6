<div class="max-w-3xl bg-white rounded-xl shadow-sm border border-gray-200 p-6">
    <h3 class="text-lg font-bold text-gray-900 mb-1">Effectuer un dépôt</h3>
    <p class="text-sm text-gray-500 mb-6">Ajouter de l'argent sur un compte bancaire.</p>
    <form action="/transaction/depot" method="POST" class="space-y-4">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Montant du dépôt *</label>
        ...
        <div class="flex justify-end pt-4 border-t border-gray-100">
            <button type="submit"
                class="bg-emerald-600 text-white px-5 py-2 rounded-lg text-sm font-medium hover:bg-emerald-700 transition-colors">Valider
                le dépôt</button>
        </div>
    </form>
</div>
